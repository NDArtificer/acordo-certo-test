package com.acordocerto.test.controller;
...
import com.acordocerto.test.repository.OportunidadeRepository;
	...
	public Oportunidade adcionar(@Valid @RequestBody Oportunidade oportunidade) {
		...
		if (oportunidadeExistente.isPresent()) {
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
					"Já existe uma oportunidade cadastrada com o mesmo Prospecto e descrição!");
		}
